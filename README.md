...
|---|---|---|---|
| 🔒 [MCBE-Client](https://github.com/Carlos-Espitia/MCBE-Client) | C++, CMake, Batchfile | MCBE-Client is a C++ mod framework for Minecraft Bedrock Edition that uses hooking and event-driven architecture to inject gameplay enhancements like aim assist, auto-clicker, and farm automation. | `Too many updates` · Jul 24, 2026<br>`Major updates to baritone` · Jul 17, 2026<br>`improved baritone navigation and added elytra supp` · Jul 14, 2026 |
| 🔒 [jobomatic](https://github.com/Carlos-Espitia/jobomatic) | Python, TypeScript, CSS, Jinja, HTML, Batchfile | Jobomatic is a desktop application that automates job application workflows by providing an intelligent bot interface with analytics dashboards, resume management, and multi-platform job site integration. | `@` · Jul 01, 2026<br>`Added web app` · Jul 01, 2026<br>`Added greenhouse, updated stuff, handshake job pos` · Jun 30, 2026 |
| [QA-voice-agent-analyzer](https://github.com/Carlos-Espitia/QA-voice-agent-analyzer) | Python | A Python-based QA testing framework that simulates voice agent conversations, records interactions, and analyzes transcripts to validate agent performance across different personas and scenarios. | `Fixed talking over bug for video` · Jun 29, 2026<br>`Analyzed 10 calls and created bug reports` · Jun 24, 2026<br>`Add architecture doc, bug report from real calls, ` · Jun 24, 2026 |
<!-- PROJECTS:END -->
