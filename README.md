...
|---|---|---|---|
| 🔒 [MCBE-Client](https://github.com/Carlos-Espitia/MCBE-Client) | C++, CMake, Batchfile | MCBE-Client is a C++ mod framework for Minecraft Bedrock Edition that provides hooking infrastructure and modular features like aim assistance, auto-mining, and packet manipulation through event-driven architecture. | `Major updates to baritone` · Jul 17, 2026<br>`improved baritone navigation and added elytra supp` · Jul 14, 2026<br>`Improved baritone` · Jul 12, 2026 |
| 🔒 [jobomatic](https://github.com/Carlos-Espitia/jobomatic) | Python, TypeScript, CSS, Jinja, HTML, Batchfile | Jobomatic is a desktop application that automates job application workflows by intelligently filling out forms and tracking application metrics across multiple job platforms. | `@` · Jul 01, 2026<br>`Added web app` · Jul 01, 2026<br>`Added greenhouse, updated stuff, handshake job pos` · Jun 30, 2026 |
