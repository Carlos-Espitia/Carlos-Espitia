...
|---|---|---|---|
| 🔒 [MCBE-Client](https://github.com/Carlos-Espitia/MCBE-Client) | C++, CMake, Batchfile | MCBE-Client is a reverse-engineered mod loader for Minecraft Bedrock Edition that injects hooks into the game client to enable modular features like aim assistance, auto-clicking, and automated farming through event-driven architecture. | `Fixed ui dump issue` · Jul 24, 2026<br>`Too many updates` · Jul 24, 2026<br>`Major updates to baritone` · Jul 17, 2026 |
| 🔒 [jobomatic](https://github.com/Carlos-Espitia/jobomatic) | Python, TypeScript, CSS, Jinja, HTML, Batchfile | Jobomatic is a desktop application that automates job applications across multiple platforms using AI, providing analytics and management tools through an Electron UI paired with a Python backend. | `@` · Jul 01, 2026<br>`Added web app` · Jul 01, 2026<br>`Added greenhouse, updated stuff, handshake job pos` · Jun 30, 2026 |
| [QA-voice-agent-analyzer](https://github.com/Carlos-Espitia/QA-voice-agent-analyzer) | Python | A Python-based QA testing system that analyzes voice agent interactions by recording calls, transcribing them, and evaluating agent performance across different personas and scenarios. | `Fixed talking over bug for video` · Jun 29, 2026<br>`Analyzed 10 calls and created bug reports` · Jun 24, 2026<br>`Add architecture doc, bug report from real calls, ` · Jun 24, 2026 |
<!-- PROJECTS:END -->
