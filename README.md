...
|---|---|---|---|
| 🔒 [jobomatic](https://github.com/Carlos-Espitia/jobomatic) | Python | Automates job applications across multiple career platforms using AI. | `changed name of project and made tweaks` · Apr 23, 2026<br>`Added chrome cdp mcp server but still need to set ` · Apr 22, 2026<br>`Added some claude stuff like page analyzer skill a` · Apr 21, 2026 |
...
| [sports-analytics](https://github.com/Carlos-Espitia/sports-analytics) | PHP | Real-time soccer fixture tracking and standings analytics platform. | `removed some seeders` · Apr 03, 2026<br>`Add API-Football integration and sync command for ` · Apr 03, 2026<br>`Added standings and fixtures pages. Also added nav` · Apr 02, 2026 |
<!-- PROJECTS:END -->
