...
|---|---|---|---|
| [SEC-financial-insights](https://github.com/Carlos-Espitia/SEC-financial-insights) | Python | This project uses Python and Streamlit to extract and analyze SEC financial data, leveraging RAG (retrieval-augmented generation) to provide insights with evaluation metrics across multiple test datasets. | `upgraded rag performance` · Jun 14, 2026<br>`Initial commit: SEC Financial Insights RAG dashboa` · Jun 05, 2026 |
| 🔒 [jobomatic](https://github.com/Carlos-Espitia/jobomatic) | Python, TypeScript, CSS, HTML, Batchfile | Jobomatic is an automation tool that applies to job postings across multiple platforms (Handshake, Indeed, Wellfound) by programmatically navigating job boards and filling out applications with user-provided information. | `Removed live logs in dashboard and added manual re` · Jun 02, 2026<br>`fixed small job title bug since handshake updated ` · Jun 02, 2026<br>`Fixed some bugs` · May 26, 2026 |
| 🔒 [financial-backtester-v2](https://github.com/Carlos-Espitia/financial-backtester-v2) | Python, TypeScript, CSS, HTML | A Python-based backtesting framework that evaluates multiple trading theories across different market conditions using machine learning optimization and historical financial data from various providers. | `Added footprint chart` · May 25, 2026<br>`More testing with volume profile, added sobol opti` · May 24, 2026<br>`Researched daily volume profile ledges, added ML f` · May 21, 2026 |
<!-- PROJECTS:END -->
