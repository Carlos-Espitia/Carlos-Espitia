...
|---|---|---|---|
| 🔒 [jobomatic](https://github.com/Carlos-Espitia/jobomatic) | Python | Automates job applications across multiple platforms using AI-generated cover letters. | `Added disclaimer usage and transitioned to using r` · Apr 24, 2026<br>`changed name of project and made tweaks` · Apr 23, 2026<br>`Added chrome cdp mcp server but still need to set ` · Apr 22, 2026 |
| 🔒 [financial-backtester-v2](https://github.com/Carlos-Espitia/financial-backtester-v2) | Python | Backtests trading strategies against historical market data with visual analysis. | `Did more testing with news wicks` · Apr 16, 2026<br>`Added imbalances and ran tests on them` · Apr 15, 2026<br>`Made updates to findings section` · Apr 15, 2026 |
| [sports-analytics](https://github.com/Carlos-Espitia/sports-analytics) | PHP | Sports analytics platform for soccer data aggregation and league tracking. | `removed some seeders` · Apr 03, 2026<br>`Add API-Football integration and sync command for ` · Apr 03, 2026<br>`Added standings and fixtures pages. Also added nav` · Apr 02, 2026 |
<!-- PROJECTS:END -->
